...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Jose"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Roberto"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("jrpbjr@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do jota, 123"))
    ...
    fun `should find customer by id and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andDo(MockMvcResultHandlers.print())  // Isso vai imprimir a resposta completa
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Jose"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Roberto"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("jrpbjr@email.com"))
    ...
    fun `should not find customer with invalid id and return 400 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class br.com.jrpbjr.creditapplicationsystem.exception.BusinessException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("JoseUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("RobertoUpdate"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "JoseUpdate",
        lastName: String = "RobertoUpdate",
